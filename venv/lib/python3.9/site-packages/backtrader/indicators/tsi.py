...
class TrueStrengthIndicator(bt.Indicator):
    ...
    Formula:
      ...
      - sm1_simple = calculate_ema(price_close_change, period1)
      - sm1_double = calculate_ema(sm1_simple, period2)
      - sm2_simple = calculate_ema(abs(price_close_change), period1)
      - sm2_double = calculate_ema(sm2_simple, period2)
